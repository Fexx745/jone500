                                        ...
                                        <tbody>
                                            <?php foreach ($result as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='../Admin/Edit/edit_customer.php?customer_id=<?php echo $row['customer_id']; ?>' class='btn btn-warning'><i class="fas fa-edit"></i></a>
                                                        <a href='../Admin/Delete/delete_customer.php?customer_id=<?php echo $row['customer_id']; ?>' class='btn btn-danger' onclick="return confirm('ยืนยันการลบข้อมูล?')"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
        ...
        <div class="modal fade" id="addCustomerModal" tabindex="-1" role="dialog" aria-labelledby="addCustomerModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="../Admin/Add/add_customer.php" method="POST">
