                                        ...
                                        <tbody>
                                            <?php foreach ($result as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../assets/imge/payments/<?php echo htmlspecialchars($row['receipt_image']); ?>" alt="ใบเสร็จ" width="50">
                                                    </td>
                                                    <td>
                                                        <a href='../Admin/Edit/edit_payment.php?payment_id=<?php echo $row['payment_id']; ?>' class='btn btn-warning'><i class="fas fa-edit"></i></a>
                                                        <a href='../Admin/Delete/delete_payment.php?payment_id=<?php echo $row['payment_id']; ?>' class='btn btn-danger' onclick="return confirm('ยืนยันการลบข้อมูล?')"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
