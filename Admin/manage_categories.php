                                        ...
                                        <tbody>
                                            <?php foreach ($result as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='../Admin/Edit/edit_category.php?category_id=<?php echo $row['category_id']; ?>' class='btn btn-warning'><i class="fas fa-edit"></i></a>
                                                        <a href='../Admin/Delete/delete_category.php?category_id=<?php echo $row['category_id']; ?>' class='btn btn-danger' onclick="return confirm('ยืนยันการลบข้อมูล?')"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
        ...
        <div class="modal fade" id="addCategoryModal" tabindex="-1" role="dialog" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="../Admin/Add/add_category.php" method="POST" enctype="multipart/form-data">
